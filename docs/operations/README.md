...
Maintainer-facing notes for operating **this template repository**.

| File | Role |
| --- | --- |
| [operations.md](operations.md) | Day-to-day operations, incidents, related links |
| [incident-response.md](incident-response.md) | Light IR checklist for template / derived-repo maintainers |
