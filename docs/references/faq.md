...
Docs-only evolution guidance for Java, Python, Go, Rust, .NET/C#, PHP, Ruby, Terraform/IaC, and Azure/AKS lives in [examples.md](examples.md). None of those sketches add application code to **this** template.
...
- [examples.md](examples.md) — Java / Python / Go / Rust / .NET / PHP / Ruby / Terraform / Azure-AKS evolution sketches
